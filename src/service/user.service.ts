...
export class UserService {
    constructor(
        @InjectRepository(UserEntity, db.deploy) private userRepository: Repository<UserEntity>,
        ...
        @InjectRepository(parentsEntity, db.deploy) private parentsRepository: Repository<parentsEntity>,
        @InjectRepository(DeleteUserLogEntity, db.deploy) private DeleteUserLogRepository: Repository<DeleteUserLogEntity>,
        @InjectRepository(delete_user_last_logEntity, db.deploy) private delete_user_last_logRepository: Repository<delete_user_last_logEntity>,
