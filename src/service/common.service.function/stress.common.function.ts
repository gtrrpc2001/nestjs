...
export const GetStressData = async (Repository: Repository<ecg_stressEntity>, eq: string, sDate: string, eDate: string): Promise<any> => {
    try {
...
const getPns_Sns = (result: any[]): { writetime: string, pns_percent: number, sns_percent: number }[] => {
