...
@Injectable()
export class Test_ArrService {
    constructor(
        @InjectRepository(ecg_csv_ecgdata_arrEntity, db.test)
        private ecg_csv_ecgdata_arrRepository: Repository<ecg_csv_ecgdata_arrEntity>,
        @InjectRepository(parentsEntity, db.test)
        private parentsRepository: Repository<parentsEntity>,
        @InjectRepository(UserEntity, db.test)
        private userRepository: Repository<UserEntity>,
        @InjectRepository(ecg_byteEntity, db.test)
