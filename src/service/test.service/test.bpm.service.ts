...
@Injectable()
export class Test_BpmService {
    constructor(@InjectRepository(ecg_csv_bpmdayEntity, db.test) private ecg_csv_bpmdayRepository: Repository<ecg_csv_bpmdayEntity>,
        @InjectRepository(ecg_raw_history_lastEntity, db.test) private ecg_raw_history_lastRepository: Repository<ecg_raw_history_lastEntity>,
        @InjectRepository(ecg_csv_ecgdata_arrEntity, db.test) private ecg_csv_ecgdata_arrRepository: Repository<ecg_csv_ecgdata_arrEntity>
    ) { }
